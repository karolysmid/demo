...
/*
   public static Decision[] filldecisions(string[] playerOptionDataSet, string[]npcOptionDataSet)
   {
  ...
  static public void Test()
   ...
   // GameObject.FindGameObjectWithTag("MakeButtons").GetComponent<MakeButtons>().CreateButtonLayout(stateList[0].GetOptions(), stateList[0].GetReplies(),true);
   ...
   static public void HandleState()
    {
     ...
     //   stateList[0].GetAnswers();
        GameObject.FindGameObjectWithTag("MakeButtons").GetComponent<MakeButtons>().CreateButtonLayout();
    }
   static public string[] HandleState(int i)
    {
     ...
     //   GameObject.FindGameObjectWithTag("MakeButtons").GetComponent<MakeButtons>().CreateButtonLayout(stateList[0].GetOptions(), stateList[0].GetReplies(),false);
    ...
    stateList.Add(new State(stateList.Count,0,TextData.NPCDataSet1, answersDataSet1));
    stateList.Add(new State(stateList.Count,0,NPCDataSet1, answersDataSet1));


    }

    internal static void GetPlayerReplies()
    {
